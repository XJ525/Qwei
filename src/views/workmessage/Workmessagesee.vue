<template>
    <div class="workmessagesee">
        <div class="head">
            <van-nav-bar title="工作通知详情" left-text="返回"   @click-left="backOn" left-arrow>
            </van-nav-bar>
        </div>
        ...
        <div class="onceArrStyle" v-if="onceArr.length > 0">
            ...
            <div class="messageConters">
                ...
                <div class="img">
                    <!-- <i v-if="item['user_head_url'] == null" >
